...
const initialMessages = [
  {
    ...
    message: 'Hi, I was wondering if you could help me with integrating the GPT-4 API into my application. I\'m having trouble with the authentication process.',
    status: 'unread',
    admin_notes: '',
  ...
  },
  {
    ...
    message: 'Would it be possible to add a comparison feature for different AI models? It would be really helpful for choosing the right API.',
    status: 'read',
  ...
  },
  {
    ...
    message: 'Just wanted to say that your directory has been incredibly helpful for my team. We\'ve found several APIs that we now use in production.',
    status: 'read',
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`${styles.button.base} ${styles.button.sizes.sm}
                  ${selectedStatus === 'unread' ? styles.button.primary : styles.button.secondary}`}
              >
                Unread
              </button>
              <button
                ...
                className={`${styles.button.base} ${styles.button.sizes.sm}
                  ${selectedStatus === 'read' ? styles.button.primary : styles.button.secondary}`}
              >
                Read
              </button>
            </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                   ${message.status === 'unread' ? 'bg-primary-100 text-primary-700' : 'bg-gray-100 text-gray-700'}`}>
                      {message.status}
                    </span>
                  </div>
